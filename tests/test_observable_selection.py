...
from cloneid_agent.observable_selection import select_observables_from_bundle_payload
...
class ObservableSelectionTests(unittest.TestCase):
    def test_select_observables_prefers_corrected_count_and_perspective(self) -> None:
        payload = {
            ...
            "identity_records": [{"size": 0.7}],
        }
        observables = select_observables_from_bundle_payload(payload)
